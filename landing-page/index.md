...
Not yet — it's on the roadmap. x402 client support requires ECDSA signing in the enclave ([#5](https://github.com/tiero/clw.cash/issues/5)) and x402 facilitators outside USDC on Base. When ready, the agent will detect `402 Payment Required`, auto-swap BTC to the required stablecoin, and retry the original request.
